...
<script>
    ...
    Ext.onReady(function () {
        ...
        var gridPanel, articleField, articleStore, ajaxSuccess,
                addMeidaWindow,
                initData = ${initData};
            ...
            selModel: {
                ...
                listeners: {
                    selectionchange: function (self, selected, eOpts) {
                        ...
                        Ext.getCmp("btn-headLineMedia").setDisabled(count != 1 || !isAccept);
                        Ext.getCmp("btn-cancelHeadLineMedia").setDisabled(count < 1 || !isFocus);

                        Ext.getCmp("btn-headLine").setDisabled(count < 1 || isHeadLine || !isAccept || urlIsEmpty);
                        Ext.getCmp("btn-cancel-headLine").setDisabled(count < 1 || !isHeadLine || !isAccept);
                        Ext.getCmp("btn-saveOrder").setDisabled(count < 1 || !isAccept);

                        Ext.getCmp("btn-staticize").setDisabled(count < 1 || !isAccept);
                        Ext.getCmp("btn-preview").setDisabled(count < 1 || !isAccept);
