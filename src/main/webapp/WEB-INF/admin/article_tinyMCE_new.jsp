                ...
                },
                {
                    ...
                    handler: function (self, e) {
                        ...
                        if (tinyMCE.editors[0]) {
                            tinyMCE.editors[0].setContent(Ext.String.htmlDecode(data['content']));
                        }

                        /* the tinyMCE don't calculate Arabic numerals */
                        // Ext.getCmp('article-content').setValue('123');
                        formWindow.show();
                    }
                },
                {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        tinyMCEConfig: {
                            ...
                            setup: function (ed) {
                                ed.on("init", function (ed, o) {
                                    var id = Ext.getCmp('article-id').getValue();
                                    if (Number.parseInt(id) > 0) {
                                        tinymce.editors[0].setContent(Ext.String.htmlDecode(gridPanel.getSelection()[0]['data']['content']));
                                    }
                                });
                            }
                        },
                    ...
                    handler: function () {
                        if (form.isValid()) {
                            ...
                            form.getForm().submit({
                                ...
                                params: {
                                    treeId: ${treeId},
                                    content: tinymce.editors[0].getBody().innerHTML
                                },
